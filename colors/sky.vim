...
exe "hi Directory gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
...
exe "hi Question gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
...
exe "hi Error gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
...
exe "hi SpecialKey gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
...
" Variable types.
exe "hi Boolean gui=NONE guifg=" s:EARTH[1] "guibg=NONE"
exe "hi Character gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Constant gui=NONE guifg=" s:SKY[2] "guibg=NONE"
exe "hi Float gui=NONE guifg=" s:EARTH[1] "guibg=NONE"
exe "hi Function gui=NONE guifg=" s:STAR[0] "guibg=NONE"
exe "hi Identifier gui=NONE guifg=" s:STAR[0] "guibg=NONE"
exe "hi Number gui=NONE guifg=" s:EARTH[1] "guibg=NONE"
...
exe "hi Conditional gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Debug gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Delimiter gui=NONE guifg=" s:SKY[4] "guibg=NONE"
exe "hi Exception gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Include gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Keyword gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Label gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Noise gui=NONE guifg=" s:SKY[4] "guibg=NONE"
exe "hi Operator gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi PreProc gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Repeat gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Special gui=NONE guifg=" s:EARTH[1] "guibg=NONE"
exe "hi SpecialChar gui=NONE guifg=" s:EARTH[1] "guibg=NONE"
exe "hi Statement gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi StorageClass gui=NONE guifg=" s:EARTH[1] "guibg=NONE"
exe "hi Structure gui=NONE guifg=" s:EARTH[0] "guibg=NONE"
exe "hi Type gui=NONE guifg=" s:EARTH[1] "guibg=NONE"
